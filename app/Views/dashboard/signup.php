...
<div id="app" class="h-screen w-full bg-white grid lg:grid-cols-2 grid-cols-1">
        ...
        <div class="flex flex-col space-y-6 relative ">
            ...
            <div v-if="pageIndex == 1" class="flex flex-col space-y-6">
                ...
                <div class="flex border border-1 border-slate-700 rounded rounded-full space-x-3 py-3 px-4">
                    ...
                    <input type="text" v-model="model.hp" name="hp" id="hp" placeholder="085123123123" class="text-black w-full outline-0">
                </div>
            </div>
